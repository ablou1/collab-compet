...
class AgentParameters():
    ...
    def __init__(self, action_size, gamma=0.99, tau_param=(0.01, 0.001, 0.999), batch_size=1024, learn_param=(20, 20), noise_factor=0.4, noise_reducer_param=(1, 0.01, 0.9995), model_update=(20, 20), model_param=(256, 512), lr_actor_critic=(1e-4, 1e-4)):
        ...
        ======
            ...
            model_update(int, int): tuple that contains the number of iterations without training and the number of training done
